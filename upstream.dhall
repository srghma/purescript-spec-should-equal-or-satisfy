...
, arrays =
    ...
    , repo =
        "https://github.com/srghma/purescript-arrays.git"
    , version =
        "fix-foldable1"
    }
, arrays-zipper =
...
, axios =
    { dependencies =
        [ "effect", "console", "foreign-generic", "aff", "prelude" ]
    , repo =
...
, call-by-name =
    { dependencies =
        [ "unsafe-coerce", "lazy", "maybe", "either", "control" ]
    , repo =
...
, fixed-precision =
    { dependencies =
        [ "integers", "maybe", "bigints", "strings", "math" ]
    , repo =
...
, free =
    ...
    , repo =
        "https://github.com/srghma/purescript-free.git"
    , version =
        "fix-foldable1"
    }
, freeap =
...
, halogen-storybook =
    { dependencies =
        [ "halogen", "prelude", "routing", "foreign-object" ]
    , repo =
...
, halogen-svg-elems =
    { dependencies =
        [ "effect", "halogen", "prelude", "strings", "web-uievents" ]
    , repo =
...
, lazy =
    ...
    , repo =
        "https://github.com/srghma/purescript-lazy.git"
    , version =
        "fix-foldable1"
    }
, lcg =
...
, logging-journald =
    { dependencies =
        [ "generics-rep", "logging", "systemd-journald" ]
    , repo =
...
, npm-package-json =
    { dependencies =
        [ "argonaut", "console", "effect", "psci-support" ]
    , repo =
...
, ordered-collections =
    ...
    , repo =
        "https://github.com/srghma/purescript-ordered-collections.git"
    , version =
        "fix-foldable1"
    }
, ordered-set =
...
, parsing-dataview =
    { dependencies =
        [ "parsing", "arraybuffer-types", "arraybuffer" ]
    , repo =
...
, selection-foldable =
    ...
    , repo =
        "https://github.com/jamieyung/purescript-selection-foldable.git"
    , version =
        "v0.2.0"
    }
, selective =
...
, sparse-matrices =
    { dependencies =
        [ "prelude", "console", "effect", "sparse-polynomials" ]
    , repo =
...
, strings =
    ...
    , repo =
        "https://github.com/instateam/purescript-strings.git"
    , version =
        "unix-parenthesis"
    }
, strings-extra =
...
, thermite =
    ...
    , repo =
        "https://github.com/paf31/purescript-thermite.git"
    , version =
        "v6.3.1"
    }
, thermite-dom =
    { dependencies =
        [ "thermite", "react", "react-dom", "web-html" ]
    , repo =
...
, trout-client =
    { dependencies =
        [ "affjax", "argonaut-generic", "prelude", "trout" ]
    , repo =
...
, tuples =
    ...
    , repo =
        "https://github.com/srghma/purescript-tuples.git"
    , version =
        "master"
    }
, tuples-native =
    { dependencies =
        [ "generics-rep", "typelevel", "unsafe-coerce" ]
    , repo =
        "https://github.com/athanclark/purescript-tuples-native.git"
    , version =
        "v2.1.0"
    }
, type-equality =
...
, uint =
    { dependencies =
        [ "generics-rep", "math", "maybe", "quickcheck" ]
    , repo =
...
, uuid =
    { dependencies =
        [ "effect", "maybe", "foreign-generic", "console", "spec" ]
    , repo =
...
, validated-molecule =
    { dependencies =
        [ "arrays", "console", "effect", "lists", "psci-support" ]
    , repo =
...
, variant =
    ...
    , repo =
        "https://github.com/JordanMartinez/purescript-variant.git"
    , version =
        "polykindsUpdate"
    }
, vectorfield =
...
, which =
    { dependencies =
        [ "arrays", "console", "effect", "nullable", "psci-support" ]
    , repo =
...
, z85 =
    { dependencies =
        [ "arraybuffer", "sized-vectors", "numbers", "stringutils" ]
    , repo =
...
, zeta =
    { dependencies =
        [ "refs", "aff", "foreign-object", "arrays" ]
    , repo =
